...
- [ ] **Phase 2: Core Rules + CLI** — First working tool: RH001/002/003/007, `proctor check`, git hook, inline suppression
...
**Plans**: 5 plans
Plans:
- [ ] 02-01-PLAN.md — Types + context extension (CLI-10), pretty reporter + json reporter (OUT-03, CLI-04)
- [ ] 02-02-PLAN.md — RH001 (test deletion) + RH002 (weakened assertions) signatures + tests
- [ ] 02-03-PLAN.md — RH003 (skip patterns) + RH007 (config exclusions) signatures + tests
...
| 2. Core Rules + CLI | 0/5 | In Progress | - |
