// ponytail: unconditional detection per Phase 2 design; cross-file correlation deferred to Phase 4
...
export function rh007(files: ParsedFile[], _ctx: RepoContext): Finding[] {
    ...
    for (const chunk of file.chunks) {
      for (const change of chunk.changes) {
        ...
        findings.push({
          ...
          remediation: `Remove ${key} entry added in this change.`,
        });
      }
    }
  }
